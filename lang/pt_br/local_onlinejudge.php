...
$string['info0'] 				= 'Se voce estava esperando muito tempo, por favor informe o administrador';
...
$string['info5'] 				= 'Voce comeu muita memoria';
...
$string['info9'] 				= '[SIGSEGV, falha Segmento] indice de array errado, acesso nao permitido a memoria ou pior';
...
$string['info22'] 				= 'Se voce esta esperando por muito tempo, por favor informe o administrador';
...
Voce deve inicia-lo o mais rapidamente possivel!';
...
$string['status23']				= 'Multiplos status';
...
$string['langjava_local'] 		= 'Java (executado localmente)';
$string['langjava_warn2err_local'] = 'Java (executado localmente, avisos como erros)';
